...
avr-g++ -c -g -Os -Wall -Wextra -std=gnu++11 -fpermissive -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics \
        ...
        -I$LIB_INCLUDE_DIR/BnrOneA \
        -I$LIB_INCLUDE_DIR/BnrRescue \
        -I$LIB_INCLUDE_DIR/BnrRoberta \
...
# core needs to be last (after libora) to avoid undefined references when used in conjuction with botnroll library
