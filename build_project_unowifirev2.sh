...
CORE_INCLUDES=$ORA_CC_RSC/hardware/additional/arduino/hardware/megaavr
...
avr-g++ -c -g -Os -Wall -Wextra -std=gnu++11 -fpermissive -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics \
		...
		-I$LIB_INCLUDE_DIR -I$PRECOMPILE_DIR/includes/ArduinoSTL/src/ \
		-I$CORE_INCLUDES/1.8.5/cores/arduino/api/deprecated \
		-I$CORE_INCLUDES/1.8.5/cores/arduino \
		-I$CORE_INCLUDES/1.8.5/variants/uno2018 \
