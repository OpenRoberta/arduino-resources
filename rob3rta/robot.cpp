...
uint8_t Robot::getTouch(uint8_t id) {
    ...
    switch(id) {
        case EAR_1:   return analog_getValueExt(ANALOG_L0, 0) & 0x01;
        case EAR_2:   return analog_getValueExt(ANALOG_R0, 0) & 0x01;
        case WHEEL_A: return analog_getValueExt(ANALOG_L1, 0) & 0x01;
        case WHEEL_B: return analog_getValueExt(ANALOG_L3, 0) & 0x01;
        case WHEEL_C: return analog_getValueExt(ANALOG_R3, 0) & 0x01;
        case WHEEL_D: return analog_getValueExt(ANALOG_R1, 0) & 0x01;
    }
    return 0;
}
...
uint8_t colorcomp_hue(uint16_t color) {
    //TODO
    return 0;
}
